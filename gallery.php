...
?>
    ...
    <section class="photo-gallery">
        <div class="container">
            ...
            <div class="row photos" data-aos="zoom-in-up" data-bss-baguettebox="">
                    ...
                    if(is_dir($folder)){
                        ...
                        if($open = opendir($folder)){
                            ...
                            while(($file= readdir($open)) != false)
                            {
                                    ...
                                    echo '<div class="col-sm-6 col-md-4 col-lg-3 item" data-bss-hover-animate="pulse"><a
                                    href="assets/upload/'.$file.'"><img
                                        class="img-fluid" src="assets/upload/'.$file.'"></a></div>';
