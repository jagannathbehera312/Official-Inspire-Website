    ...
    <?php
        ...
        if(isset($_POST['upload']))
        {
            ...
            if(move_uploaded_file($file_tem_loc,$file_store)){
                ...
                <strong>Success!</strong> Poster has been successfully uploaded.
        ...
        <div class="row mh-100vh">
            <div class="col-10 col-sm-8 col-md-6 col-lg-6 offset-1 offset-sm-2 offset-md-3 offset-lg-0 align-self-center d-lg-flex align-items-lg-center align-self-lg-stretch bg-white p-5 rounded rounded-lg-0 my-5 my-lg-0"
                ...
                <div class="m-auto w-lg-75 w-xl-50">
                    <h2 class="text-info fw-light mb-5"><i class="fa fa-image"></i>&nbsp;Upload Poster</h2>





                    <form action="poster_uploader.php" method="POST" enctype="multipart/form-data">
                        



                        <div class="form-group mb-3"><label for="formFile" class="form-label text-secondary">Select the Image</label><input
                                class="form-control" type="file" id="formFile" name="file" required=""></div>

                                <button class="btn btn-info mt-2" type="submit" name="upload">Upload</button>
