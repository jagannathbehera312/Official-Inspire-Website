...
if(isset($_POST['submit']))
{
    ...
    $sql = "INSERT INTO contact_us ( `name`,`email`, `message`) VALUES ( '$name', '$email_id','$msg')";
...
?>
    ...
    <section class="contact-clean">
        <form data-aos="zoom-in" method="post">
            <h2 class="text-center">Contact us</h2>
            <div class="mb-3"><input class="border-primary form-control" type="text" name="name" placeholder="Name"
                    required="" minlength="5" maxlength="20"></div>

            <div class="mb-3"><input class="border-primary form-control is-invalid" type="email" name="email"
                    placeholder="Email" required="" minlength="10" maxlength="40"></div>

            <div class="mb-3"><textarea class="border-primary form-control" name="message" placeholder="Message"
                    rows="14" required="" minlength="10" maxlength="600"></textarea></div>

            <div class="mb-3"><button class="btn btn-primary" type="submit" name="submit">SUMBIT</button></div>
        </form>
    </section>
